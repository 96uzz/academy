    ...
    <div class="body-container2">
		...
		<div class="content2" style="font-size: 30px; font-weight: 800; color: #3598DB; width: 800px;">
			...
			<table style="width: 100%;">
				<tr height="35px;">
					<td align="right">
						<form name="selectForm" action="<%=cp%>/lts/list.do" method="post" onchange="selectList();">
			...
			<table style="width: 100%; margin: 10px auto; border-spacing: 0px;">
			   <tr height="40">
			      <td align="left" width="100">
			          <button type="button" class="loginButton" onclick="javascript:location.href='<%=cp%>/lts/list.do';">새로고침</button>
			      </td>
			      <td align="center">
			      ...
			      <td align="right" width="100">
			          ...
			          <button type="button" class="loginButton" onclick="javascript:location.href='<%=cp%>/lts/created.do';">글올리기</button>
			        </c:if>
			      </td>
			   </tr>
			</table>
